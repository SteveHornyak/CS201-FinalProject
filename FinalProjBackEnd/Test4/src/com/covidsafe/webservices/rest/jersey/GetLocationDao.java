...
public class GetLocationDao
{
	public LocationResponse getLocation(String yelpID)
	{
		...
		return new LocationResponse(curr_id,yelpId,isOp,isSD,pu,IA,OA,Bath,AS,uten,ppe,crr,notes,curb,deliv,posCovidTest,ratings,status);
	}
}
